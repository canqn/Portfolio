...
import perfil from '../../../image/iam.png'
                ...
                <div className='home__container container grid'>
                    <div className='home__content grid'>
                        <div className='home__social'>
                            <a href='https://linkedin.com/in/canqn' rel="noreferrer" className='home__social-icon' target='_blank'>
                                <UilLinkedinAlt size='20' />
                            </a>
                            <a href='https://join.skype.com/invite/FIqpyUju6Qj1' rel="noreferrer" className='home__social-icon' target='_blank'>
                                <UilSkypeAlt size='20' />
                            </a>
                            <a href='https://github.com/canqn' rel="noreferrer" className='home__social-icon' target='_blank'>
                        ...
                        <div className='home__img'>
                            <svg className='home__blob' viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg"
                                ...
                                -0.149132 97.9666 0.00163737C136.23 0.303176 174.193 10.857 190.312 36.4879Z" />
                                    <image className="home__blob-img" x='-42' y='20' xlinkHref={perfil} />
